module.exports = (_ => {
	...
	// If BDFDB_Global doesn't exist OR BDFDB_Global.loaded or .started is false
	// TRUE => Return a Loading class component that loads the BDFDB library
	// FALSE => Return the NotificationsComponent
	return !window.BDFDB_Global || (!window.BDFDB_Global.loaded && !window.BDFDB_Global.started) ? class {
		...
		// Plugin is a passed in class from the BDFDB library
		// BDFDB is the BDFDB library loaded in
		var _this;
